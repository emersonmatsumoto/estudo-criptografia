...
### Adicionar usuário ao grupo `tss`

Para acessar `/dev/tpmrm0` sem privilégios de root:
...
### Gerar a chave RSA 2048 dentro do TPM
...
**Remover chave:** Use o comando abaixo (o ID você encontra no `listobj`):

```console
tpm2_ptool objdel --id <ID>
```
